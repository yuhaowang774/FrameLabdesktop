...
- **多种 INFO 布局**：经典纵向 / 杂志双栏 / 悬浮双行 / 手机白底水印卡 / 杂志编辑（顶部标题 + 照片自动取色色卡）/ 竖排装裱（文字旋转 90° 沿照片左缘竖排）；信息块可贴底或贴顶（报头式）
...
- **相框模板库**：62 套内置模板（经典 / 极简轻量 / 杂志编辑 / 胶片复古 / 暗调影廊 / 联名卡 / 社交尺寸 / 水印署名 / 多彩色卡 / 大师水印 / 日历边框 / 运动边框 / 设备样机 / 创意排版 十四大系列）+ 自定义模板（当前照片实时合成预览、重命名、分类筛选与搜索、单模板与模板包导入导出 JSON）
