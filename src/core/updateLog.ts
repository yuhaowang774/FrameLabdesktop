...
export const UPDATE_LOG: UpdateEntry[] = [
  {
    ...
    groups: {
      added: [
        ...
        '运动遥测：支持导入运动手表 / App 导出的 GPX 文件，自动解析距离 / 时长 / 均速 / 爬升与轨迹，新增「运动遥测」布局（轨迹缩略卡 + 四栏参数表）；新增「运动·暗调遥测 / 白底数据表」模板',
        '设备样机：照片可装进手机机身轮廓（深空灰 / 银色两种配色，含边框环与灵动岛），预览与成片完全一致；新增「设备样机·深空灰 / 银色」模板',
        '杂志封面款：新增「杂志封面·刊头款 / 展览款」模板——全幅照片压衬线大标题 + 报头行，展览款带多行介绍段落',
        'GPS 坐标款：新增「GPS坐标·旅行印迹」模板，机型 / 拍摄日期 / 经纬度三行贴底展示（坐标随照片 EXIF 自动填充，缺失自动隐藏）',
        '模板库新增「日历边框 / 运动边框 / 设备样机」三个分组，内置模板扩充至 62 套',
      ],
      improved: [
