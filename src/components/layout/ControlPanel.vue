...
const DEFAULT = {
  ...
  // INFO
  infoLayout: 'classic' as 'classic' | 'duo' | 'inline' | 'card' | 'magazine',
  infoCardTheme: 'white' as 'white' | 'black',
  showLogo: false,
  ...
  lensText: '',
  dateText: '',
  dateFormat: 'date' as 'date' | 'datetime' | 'zh' | 'dash',
...
function resetInfo() { patch({
  infoLayout: DEFAULT.infoLayout, infoCardTheme: DEFAULT.infoCardTheme,
  showLogo: DEFAULT.showLogo, showCameraModel: DEFAULT.showCameraModel, showExif: DEFAULT.showExif,
  showLens: DEFAULT.showLens,
  showDate: DEFAULT.showDate, cardShowDate: DEFAULT.cardShowDate,
  eqFocal: DEFAULT.eqFocal, cropFactor: DEFAULT.cropFactor,
  brand: DEFAULT.brand, logoColor: DEFAULT.logoColor, logoSize: DEFAULT.logoSize, logoOpacity: DEFAULT.logoOpacity,
  cardBadgeBg: DEFAULT.cardBadgeBg, cardBadgeFg: DEFAULT.cardBadgeFg,
  cameraModel: DEFAULT.cameraModel, cameraModelSize: DEFAULT.cameraModelSize,
  exifText: DEFAULT.exifText, lensText: DEFAULT.lensText,
  dateText: DEFAULT.dateText, dateFormat: DEFAULT.dateFormat,
